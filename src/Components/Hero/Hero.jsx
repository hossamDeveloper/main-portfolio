    ...
    return (
        <div className='flex relative'>
            ...
            <div className='w-1/2 h-screen flex flex-col justify-between  py-10'>
                ...
                <div ref={ref} onClick={handleScrollToNextSection} className='w-9 h-16  relative z-50 rounded-full border-2 border-[#f4c1ce] flex items-center justify-center cursor-pointer after:content-[""] after:w-1 after:h-5 after:rounded-full after:bg-[#f4c1ce] after:absolute  after:animate-moveDownAnimation  '>
                </div>
            </div>
            ...
            <div className='w-1/2 flex flex-col justify-between items-end pb-10'>
                ...
                <div className="w-24 h-24 bg-[#f4c1ce] rounded-full relative animate-spin cursor-pointer">
